...
%[vertices faces] = readObj('nii2mesh_colin27_MNI.obj');
%[vertices faces] = readObj('nii2mesh_average305_t1_tal_lin_mask.obj');
...
%% test 
figure
gmL = importGeometry("lh.pial.stl");
gmR = importGeometry("rh.pial.stl");

%%

pdegplot(gmL); hold on; 
pdegplot(gmR)

%%
model = createpde;
importGeometry(model,"lh.pial.stl");
