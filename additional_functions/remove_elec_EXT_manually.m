function [EEG] = remove_elec_EXT_manually (EEG, subji)
        ...
        if subji ==1
          chans2exc = {'POL F''4'; 'POL F''5'; ; 'POL A''1';'POL V''5';'POL T''10'; 'POL L''14'}; 
        end
        if subji ==2
        ...
        if subji == 6
         ...
         if subji == 7
             chans2exc = {'POL J''5'; 'POL V''5';'POL V''6'}; 
         end
         if subji == 8
             chans2exc = {'POL H''1'; 'POL Y''1'; 'POL C''2'; 'POL X15'; 'POL X14';'POL R13';'POL R14';'POL Q14';'POL Q12'};
         end
        if subji == 9
            chans2exc = {'POL F''6'; 'POL F''7'; 'POL X''9';'POL J''14';'POL J''13'; 'POL J''8';'POL L''14'}; 
        end
         if subji == 10
             chans2exc = {'POL J''1';'POL WJ2';'POL J1';'POL J2';'POL J3';'POL H11'}; 
         end
        ...
        if subji == 24
            chans2exc = {'POL Z''1'; 'POL F''13'; 'POL T''11'; 'POL A''1'; 'POL R''5'; 'POL X''4'; 'POL V''7'; 'POL Y''4';'POL F''1'}; 
        end
        if subji == 25
            chans2exc = {'POL F''10'; 'POL L''12'; 'POL X''5'; 'POL X''6'; 'POL V''5'; 'POL T''4';'POL W''6';'POL V''9'}; 
        end
        if subji == 26
            chans2exc = {'POL B''2'; 'POL R''11'; 'POL X''4'; 'POL O''4'; 'POL B''8';'POL R''9';'POL R''10';'POL W''7';'POL T''7'}; 
        end
        if subji == 27
            chans2exc = {'POL V4'; 'POL W11'; 'POL A4'; 'POL Z1'; 'POL Z2'; 'POL Z7'; 'POL Z10'; 'POL Z11'; 'POL H4'; 'POL V''6'; 'POL W5'; ...
                         'POL J11'; 'POL J12'; 'POL H''4';'POL H''8';'POL H9'};
        end
         if subji == 28
        ...
        if subji == 29
            chans2exc = {'POL H3' ; 'POL H''4'; 'POL A4'; 'POL X6';'POL W14';'POL W15';'POL J10'; 'POL V''6'; ; 'POL A11'};
        end
        if subji == 30
            chans2exc = {'POL J4' ; 'POL J5'; 'POL J11';'POL V5';'POL F11';'POL A11'};
        end
        if subji == 31
            chans2exc = {'AmT2_7'; 'HmT2_6'; 'HpT2_8'; 'TObp_4'; 'TBmd_1'; 'OLa_1'; 'HpT2_4';'HmT2_7'}; 
        end
        if subji == 32
        ...
        if subji == 39
            chans2exc = {'HaT1_3';'TBa_1'}; 
        end
        if subji == 40
            chans2exc = {'TBp_3';'TBp_6'};
        end
        ...
        if subji == 43
            chans2exc = {'HaT2_6'; 'HaT2_8'; 'TBa_4'; 'TBm_4'; 'TBm_5'; 'HaT2_2';'HaT2_3';'Am2d_4' ;'HaT2_1'; 'Ha1d_3';'T1a_1';'TBa_2' }; 
        end   
        if subji == 44
            chans2exc = {'Am2g_8'; 'Ha2d_8'; 'TPod_7'; 'TBad_7'; 'Ha2g_3'; 'Ha2d_2'; 'Ha2d_3'; 'Ha2d_4'; 'Am2g_3';'TPog_1';'T1pd_2';'T1pd_1';'Ha2d_7';'TBag_6'}; 
        end
        if subji == 45
            chans2exc = {'TBm_5'; 'AmT2_3';'HaT2_5';'TBm_1';'HmT2_3';'AmT2_6'};
        end    
        if subji == 46
        ...
        if subji == 48
            chans2exc = {'TBa_3'; 'HmT2_4'}; 
        end   
        if subji == 49
            chans2exc = {'HmT2_4';'TBp_7'}; 
        end   
        if subji == 50
            chans2exc = {'TBa_1';'O3a_1';'TBp_3'}; 
        end  
